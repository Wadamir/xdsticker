...
class ModelExtensionModuleXDStickers extends Model
{
    ...
    public function updateBulkCustomXDStickerProduct($module_categories, $module_manufacturers, $module_xdsticker_id)
    {
        $filter_data = array(
    ...
    public function deleteBulkCustomXDStickerProduct($module_categories, $module_manufacturers, $module_xdsticker_id)
    {
        $filter_data = array(
            'filter_category' => $module_categories,
            'filter_manufacturer' => $module_manufacturers
