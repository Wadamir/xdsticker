...
class ControllerExtensionModuleXDStickers extends Controller
{
    ...
    public function index()
    {
        ...
        $data['default_styles'] = '.xdstickers_wrapper {position:absolute; z-index:999; color:#fff; text-transform:uppercase; font-weight:bold; line-height:1.75;} .xdstickers_wrapper.position_upleft {top:5px; left:15px; right:auto;} .xdstickers_wrapper.position_upright {top:5px; right:15px; left:auto;} .xdstickers {padding:0 10px; margin-bottom:5px;}';
        ...
        $data['text_tab_viewed_title'] = $this->language->get('text_tab_viewed_title');
        ...
        $data['entry_sticker_viewed_property'] = $this->language->get('entry_sticker_viewed_property');
        ...
        if (isset($xdstickers) && $xdstickers['position']) {
		...
		*/
        ...
        if (empty($custom_xdstickers)) {
            ...
            foreach ($custom_xdstickers as $custom_xdsticker) {
                $data['custom_xdstickers'][] = array(
                    ...
                    'tooltip'         => json_decode($custom_xdsticker['tooltip'], true),
        ...
        $data['bulk_manufacturers'] = $this->getAllManufacturers();
    ...
    public function getAllManufacturers()
    {
        ...
        foreach ($manufacturers as $manufacturer) {
            $output[$manufacturer['manufacturer_id']] = array(
    ...
    public function bulkAddCustomXDStickers()
    {
        ...
        if (isset($this->request->request['module_bulk_categories']) && empty($json)) {
            ...
            $status = $this->model_extension_module_xdstickers->updateBulkCustomXDStickerProduct($this->request->request['module_bulk_categories'], $this->request->request['module_bulk_manufacturers'], $this->request->request['module_bulk_custom_xdstickers']);
            // var_dump($status);
    ...
    public function bulkDeleteCustomXDStickers()
    {
        ...
        if (!$this->user->hasPermission('modify', 'extension/module/xdstickers')) {
            ...
            if (isset($this->request->request['module_bulk_categories']) && empty($json)) {
                ...
                $status = $this->model_extension_module_xdstickers->deleteBulkCustomXDStickerProduct($this->request->request['module_bulk_categories'], $this->request->request['module_bulk_manufacturers'], $this->request->request['module_bulk_custom_xdstickers']);
                // var_dump($status);
                if ($status) {
